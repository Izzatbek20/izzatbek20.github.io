...
<template>
  <section class="flex flex-col justify-center h-lvh line-bottom">

    <!-- Navbar -->
    <Navbar />
    <!-- /Navbar -->

    <div class="basis-10/12 container-imm flex flex-col justify-center">
      <div>
    ...
    <!-- Down arrow icon -->
    <div class="basis-1/12 mt-6 mx-auto animate-bounce">
