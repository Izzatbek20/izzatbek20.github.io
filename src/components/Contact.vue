  ...
  <section id="aloqa-malumotlarim"
    ...
    <div>
      <h2 class="font-bold text-xl">
        <span class="text-gray-500 font-light ">Aloqa</span> ma'lumotlarim
      </h2>
    </div>
    ...
    <div class="flex flex-col lg:flex-row items-end gap-8">
      <div class="flex-1/2 flex flex-col justify-center gap-10">
        ...
        <ul class="flex justify-start items-center  gap-5">
          ...
          <li class="border border-gray-500 rounded-full p-2">
            <a aria-label="Linkedin" href="https://linkedin.com/in/izzatbek20" target="_blank"
          ...
          <li class="border border-gray-500 rounded-full p-2">
            <a aria-label="Email" href="mailto:izzatbekmajidov200020@gmail.com" target="_blank"
              rel="noopener noreferrer">
              <svg class="size-4 text-gray-500" fill="currentColor" role="img" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <title>Email</title>
